...
public class KvDB {
    ...
    public synchronized int updateData(String key, String value) {
     ...
     * 删除指定key 的config
     */
    public synchronized int deleteData(String key) {
        ...
        c.moveToFirst();
        return db.delete(KVDataEntry.TABLE_NAME, "key=?", new String[]{key});
    }
